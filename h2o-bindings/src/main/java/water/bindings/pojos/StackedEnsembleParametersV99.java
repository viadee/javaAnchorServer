...
public class StackedEnsembleParametersV99 extends ModelParametersSchemaV3 {
    ...
    /**
     * List of models (or model ids) to ensemble/stack together. Models must have been cross-validated using nfolds > 1,
    ...
    public StackedEnsembleModelStackedEnsembleParametersMetalearnerAlgorithm metalearnerAlgorithm;
    ...
    */
    ...
    public StackedEnsembleParametersV99() {
        ...
        metalearnerAlgorithm = StackedEnsembleModelStackedEnsembleParametersMetalearnerAlgorithm.AUTO;
        metalearnerNfolds = 0;
