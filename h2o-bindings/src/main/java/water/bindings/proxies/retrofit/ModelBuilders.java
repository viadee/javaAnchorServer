...
public interface ModelBuilders {
  ...
  Call<XGBoostV3> trainXgboost(
    ...
    @Field("n_estimators") int n_estimators,
    ...
    @Field("min_sum_hessian_in_leaf") float min_sum_hessian_in_leaf,
    @Field("min_data_in_leaf") float min_data_in_leaf,
  ...
  Call<DeepWaterV3> trainDeepwater(
    @Field("problem_type") DeepWaterParametersProblemType problem_type,
    @Field("activation") DeepWaterParametersActivation activation,
    @Field("hidden") int[] hidden,
    @Field("input_dropout_ratio") double input_dropout_ratio,
    @Field("hidden_dropout_ratios") double[] hidden_dropout_ratios,
    @Field("max_confusion_matrix_size") int max_confusion_matrix_size,
    ...
    @Field("target_ratio_comm_to_comp") double target_ratio_comm_to_comp,
    @Field("seed") long seed,
    @Field("learning_rate") double learning_rate,
    @Field("learning_rate_annealing") double learning_rate_annealing,
    @Field("momentum_start") double momentum_start,
    @Field("momentum_ramp") double momentum_ramp,
    @Field("momentum_stable") double momentum_stable,
    @Field("score_interval") double score_interval,
    ...
    @Field("shuffle_training_data") boolean shuffle_training_data,
    @Field("mini_batch_size") int mini_batch_size,
    @Field("clip_gradient") double clip_gradient,
    @Field("network") DeepWaterParametersNetwork network,
    @Field("backend") DeepWaterParametersBackend backend,
    @Field("image_shape") int[] image_shape,
    @Field("channels") int channels,
    @Field("gpu") boolean gpu,
    @Field("device_id") int[] device_id,
    @Field("cache_data") boolean cache_data,
    @Field("network_definition_file") String network_definition_file,
    @Field("network_parameters_file") String network_parameters_file,
    @Field("mean_image_file") String mean_image_file,
    @Field("export_native_parameters_prefix") String export_native_parameters_prefix,
    @Field("standardize") boolean standardize,
    @Field("balance_classes") boolean balance_classes,
    @Field("class_sampling_factors") float[] class_sampling_factors,
    @Field("max_after_balance_size") float max_after_balance_size,
   ...
   *   @param base_models List of models (or model ids) to ensemble/stack together. Models must have been cross-
   *                      validated using nfolds > 1, and folds must be identical across models.
  ...
  Call<StackedEnsembleV99> trainStackedensemble(
    ...
    @Field("metalearner_algorithm") StackedEnsembleModelStackedEnsembleParametersMetalearnerAlgorithm metalearner_algorithm,
  ...
  class Helper {
     ...
     * Train a DeepWater model.
     */
    public static Call<DeepWaterV3> trainDeepwater(ModelBuilders z, DeepWaterParametersV3 p) {
      return z.trainDeepwater(
        p.problemType,
        p.activation,
        p.hidden,
        p.inputDropoutRatio,
        ...
        p.deviceId,
        p.cacheData,
        p.networkDefinitionFile,
        p.networkParametersFile,
        p.meanImageFile,
        p.exportNativeParametersPrefix,
        p.standardize,
        p.balanceClasses,
        p.classSamplingFactors,
        p.maxAfterBalanceSize,
     ...
     * Validate a set of DeepWater model builder parameters.
     */
    public static Call<DeepWaterV3> validate_parametersDeepwater(ModelBuilders z, DeepWaterParametersV3 p) {
      return z.validate_parametersDeepwater(
        p.problemType,
        p.activation,
        p.hidden,
        p.inputDropoutRatio,
